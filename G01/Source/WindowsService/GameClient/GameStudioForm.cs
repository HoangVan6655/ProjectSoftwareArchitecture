...
namespace GameClient
{
    ...
    {
        const String URL = "tcp://127.0.0.1:6789/Studio";
        ...
        {
            List<Studio> studios = studioBUS.GetAll();
        ...
        private void dgvStudio_SelectionChanged(object sender, EventArgs e)
        {
            if (dgvStudio.SelectedRows.Count > 0)
            {
                ...
                Studio studio = studioBUS.GetDetails(code);
                if (studio != null)
                {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            List<Studio> studios = studioBUS.Search(keyword);
            dgvStudio.DataSource = studios;
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            bool result = studioBUS.AddNew(newStudio);
            if (result)
            {
                List<Studio> studios = studioBUS.GetAll();
                dgvStudio.DataSource = studios;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            bool result = studioBUS.Update(newStudio);
            if (result)
            {
                List<Studio> studios = studioBUS.GetAll();
                dgvStudio.DataSource = studios;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                bool result = studioBUS.Delete(id);
                if (result)
                {
                    List<Studio> studios = studioBUS.GetAll();
                    dgvStudio.DataSource = studios;
